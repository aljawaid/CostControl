...
class HourlyRateController extends BaseController
{
    public function show()
    {
        ...
        $this->response->html($this->helper->layout->user('costControl:hourlyrate/show', array(
    ...
    public function create(array $values = array(), array $errors = array())
    {
        ...
        $this->response->html($this->helper->layout->user('costControl:hourlyrate/create', array(
            'rates' => $this->hourlyRate->getAllByUser($user['id']),
            'currencies_list' => $this->currencyModel->getCurrencies(),
    ...
    public function save()
    {
        ...
        if ($valid) {
            if ($this->hourlyRate->create($values['user_id'], $values['rate'], $values['currency'], $values['date_effective'])) {
                ...
                $this->response->redirect($this->helper->url->to('HourlyRateController', 'show', array('plugin' => 'CostControl', 'user_id' => $values['user_id'])), true);
                return;
            } else {
    ...
    public function confirm()
    {
        ...
        $this->response->html($this->template->render('costControl:hourlyrate/remove', array(
    ...
    public function remove()
    {
        ...
        $this->response->redirect($this->helper->url->to('HourlyRateController', 'show', array('plugin' => 'CostControl', 'user_id' => $user['id'])), true);
    }
}
