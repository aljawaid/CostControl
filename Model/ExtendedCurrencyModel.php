...
class ExtendedCurrencyModel extends Base
{
    ...
    public function getCurrencies()
    {
        return array(
            ...
            'XDR' => t('XDR/SDR - International Monetary Fund (IMF) Special Drawing Rights'),
            'XBT' => t('XBT/BTC - Bitcoin'),
   ...
   public function getLiveRates()
    {
        ...
        error_log('live rate update:'.$live_rate_updated,0);
